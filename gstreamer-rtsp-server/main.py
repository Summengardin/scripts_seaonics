...
class VideoServerRTSP:
    ...
    def _generate_gst_rtsp_server(self):
        ...
        if source == "usb_cam":
            ...
            pipeline = "pylonsrc ! video/x-raw, width=1280 , height=720, format=(string)YUY2, framerate=160/1 ! nvvidconv ! nvv4l2h264enc enable-full-frame=true ! rtph264pay pt=96 name=pay0"
        elif source == "test":
